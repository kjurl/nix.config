# https://github.com/erahhal/nixcfg/blob/51b6729d4726273d6bebec1dbfdd167f280198f7/pkgs/fusion360/default.nix#L120
...
{ pkgs, stdenv, lib, fetchurl, makeDesktopItem, imagemagick, makeWrapper }:
let
  version = "v7.6.9";
  ...
  srcs = {
    fusion360-installer = fetchurl {
      url =
        "https://raw.githubusercontent.com/cryinkfly/Autodesk-Fusion-360-for-Linux/0df56158500bc1c8bb19c209e14747fef76b411f/files/builds/stable-branch/bin/install.sh";
...
in stdenv.mkDerivation rec {
  ...
  desktopItems = let mimeTypes = [ "x-world/x-3dmf" "application/x-3dmf" ];
  in [
    (makeDesktopItem rec {
      inherit mimeTypes;
      inherit name;
