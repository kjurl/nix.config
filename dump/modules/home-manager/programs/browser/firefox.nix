        ...
        default = {
          ...
          search = {
            ...
            engines = {
              ...
              "Nix Packages" = lib.firefoxSearchEngine {
                aliases = [ "@np" ];
                params = [
              ...
              "Nix Packages Versions" = lib.firefoxSearchEngine {
                aliases = [ "@npv" ];
                params = [
              ...
              "Home-manager Options" = lib.firefoxSearchEngine {
                aliases = [ "@hm" ];
                params = [
              ...
              "NixOS Wiki" = lib.firefoxSearchEngine {
                aliases = [ "@nw" ];
                params =
                  [ "https://wiki.nixos.org/index.php" "query:{searchTerms}" ];
                icon =
                  "${pkgs.nixos-icons}/share/icons/hicolor/scalable/apps/nix-snowflake.svg";
              };
            };
